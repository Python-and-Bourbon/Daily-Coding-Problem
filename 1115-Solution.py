...
# The problem states that it only wants to see if exactly two numbers add up to k. 
# I am assuming this means we should return Yes/No instead of the two numbers.
...
def solver(ls, k):
    ...
    for i in ls:
        ...
        # Using try/except here in case i is not a number. Test case does not tell us explicitly (i.e. 'seven' instead of 7)
        try: closer[k - i] = True
